...
from eulerian_magnification import base, io
...
def main(args):
    ...
    for vid_name in all_paths:
        ...
        vid, fps = em.io.load_video_float(vid_path)
        output_vid = em.base.eulerian_magnification(vid, fps,
                                                    freq_min=50.0 / 60.0,
                                                    freq_max=1.0,
                                                    amplification=50,
                                                    pyramid_levels=3)
        em.io.save_video(output_vid, fps)
